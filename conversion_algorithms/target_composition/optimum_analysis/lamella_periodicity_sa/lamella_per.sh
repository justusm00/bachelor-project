...
python3 config_umbrella.py coord.h5 0.5 1 $2
#run soma
./SOMA -c coord.h5 -a coord_ana.h5 -t 2 -r 0 > temp.csv
grep 'MSE after annealing:' temp.csv | sed 's/^.*: //' > opt.csv

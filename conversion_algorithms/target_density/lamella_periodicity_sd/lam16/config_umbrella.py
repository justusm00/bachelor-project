...
# @Last Modified time: 2023-06-22 12:53:27
import h5py
import numpy as np
import sys

#routine to adjust umbrella field, area51 and minimum annealing temperature
##usage: python3 config_umbrella.py <coordfile> <delta_phi>  <total_density> <alpha> <Tmax> <lamella_width>

...
# @Last Modified time: 2023-05-09 10:23:14

#Usage: bash optimum_no_sa.sh <Nbar> <delta_phi> 


mkdir Nbar"$1"_dphi"$2"_no_sa
cp config_umbrella.py ./Nbar"$1"_dphi"$2"_no_sa/config_umbrella.py
cp coord_no_sa.xml ./Nbar"$1"_dphi"$2"_no_sa/coord.xml
cp -r ConfGen.py ./Nbar"$1"_dphi"$2"_no_sa/ConfGen.py
cp -r SOMA ./Nbar"$1"_dphi"$2"_no_sa/SOMA
cd Nbar"$1"_dphi"$2"_no_sa
